...
/**
 * Access restriction page for role-based authorization failures.
 */
const UnauthorizedPage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-theme-pale p-8">
            <div className="max-w-md w-full text-center bg-white p-12 rounded-3xl shadow-xl shadow-theme-navy/5 animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full px-8 py-3 bg-white text-theme-blue border border-theme-pale rounded-xl font-semibold hover:bg-theme-pale transition-all"
                    >
                        Switch Account
                    </button>
                </div>
            ...
            <p className="mt-8 text-xs text-slate-400 uppercase tracking-widest font-bold">
                Security Perimeter • LibraryHub System
            </p>
        </div>
    );
};
