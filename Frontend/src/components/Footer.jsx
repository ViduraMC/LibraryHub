 ...
 * 4-column layout: Brand | Quick Links | Resources | Hours & Contact.
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
                    ...
                    <div>
                        <div className="flex items-center gap-2.5 mb-4">
                            ...
                            <span className="text-base font-black tracking-tight uppercase">LibraryHub</span>
                        </div>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-[#DBEAFE] mb-4">Quick Links</h4>
                    ...
                    {/* Resources */}
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-[#DBEAFE] mb-4">Resources</h4>
                        <ul className="space-y-2.5">
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="text-[10px] font-black uppercase tracking-widest text-[#DBEAFE] mb-4">Contact</h4>
                        <div className="space-y-3 text-xs text-slate-400">
                            <div className="flex items-start gap-2">
                                <svg className="h-3.5 w-3.5 text-[#DBEAFE] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <a href="mailto:libraryhub.se@gmail.com" className="hover:text-white transition-colors">
