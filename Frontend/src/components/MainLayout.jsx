...
/**
 * Standard layout for authenticated sections of the application.
 * Includes the persistent navigation bar and a content area.
 */
const MainLayout = () => {
    return (
        <div className="min-h-screen bg-meridian-white flex flex-col">
            <Navbar />
            ...
            <footer className="py-6 border-t border-slate-100 text-center text-xs text-slate-400 font-medium">
                © {new Date().getFullYear()} Meridian School Library Management System • All Rights Reserved
            </footer>
        </div>
    );
};
