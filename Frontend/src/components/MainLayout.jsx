 ...
 * Includes the persistent navigation bar, content area, and premium footer.
 */
const MainLayout = () => {
    return (
            ...
            <footer className="bg-[#0A2463] text-white mt-12">
                ...
                <div className="container mx-auto px-6 pt-14 pb-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                        ...
                        {/* Resources */}
                        <div>
                            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#DBEAFE] mb-5">For Members</h4>
                            <ul className="space-y-3">
                                {[
                        ...
                        <div>
                            ...
                            <div className="space-y-3 text-sm text-slate-400">
                                ...
                                <div className="flex justify-between">
                                    <span>Saturday</span>
                                    <span className="text-white font-bold">8:00 AM – 12:00 PM</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Sunday</span>
                                ...
                                <div className="pt-3 mt-3 border-t border-white/10">
                                    <div className="flex items-center gap-2 text-slate-400">
                                        ...
                                        <span className="text-sm">library@school.edu</span>
                                    </div>
                                </div>
                            </div>
                        </div>
